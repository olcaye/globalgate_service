...
@section('guest-content')
    ...
    <div class="app-auth-container">
        <div class="logo">
            <a href="{{ route('agency.login') }}">Global Gate - Agency</a>
        </div>
        <p class="auth-description">Please sign-in to your account and continue to the dashboard.<br>Don't have an account? <a href="{{ route('agency.register') }}">Sign Up</a></p>
        ...
        @endif
        <form role="form" class="text-start" method="POST" action="{{ route('agency.login.post') }}">
            @csrf
