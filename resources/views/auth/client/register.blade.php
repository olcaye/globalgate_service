...
<body>
<form action="{{ route('client.register.post') }}" class="form-signin" method="post">
    @csrf
    ...
    <div class="mb-3">
        ...
        <input name="name" type="text" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Your Name" required autofocus value="{{ old('name') }}">
        @if ($errors->has('name'))
    ...
    <div class="mb-3">
        ...
        <input name="phone_number" type="text" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone" required autofocus value="{{ old('phone_number') }}">
    ...
    <div class="mb-3">
        <div class="form-group">
            <select class="countries form-control @error('country') is-invalid @enderror"
                    id="country-dd" name="country" data-placeholder="Nationality">
                <option value=""></option>
